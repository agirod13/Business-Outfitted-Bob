...
class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    // Display text showing how fast Bob is moving
    let speedText = this.add.text(0, 0, `Speed: ${speed}`, {
      fontSize: "25px",
      fill: "#fff",
    });
    ...
    this.physics.add.overlap(gameState.player, gameState.money, () => {
      ...
      // Increase the speed after increasing score
      speed += 0.1;
      // Update cash total text
      scoreText.setText(`Earnings: \$${score}`);
      // Update speed total text
      speedText.setText(`Speed: ${speed.toFixed(1)}`);
